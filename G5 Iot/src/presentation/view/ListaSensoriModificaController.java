	...
	private void initialize() {
		...
		eliminaButton.setOnAction((event) -> {
			...
			alert.setContentText(
					"Eliminare il sensore " + sensoreSelezionato.getModello() + " (" + sensoreSelezionato.getID() + ") "
							+ "dell'impianto " + ListaImpiantiController.impiantoSelezionato.getNomeI() + " ("
							+ ListaImpiantiController.impiantoSelezionato.getIdI() + ") " + "del cliente "
